...
type getPageNumbers = (view : RedirectionsStore, perPage: number) => Array<number>;
    ...
    return (
        <div className='alignright actions' style={{display: 'flex'}}>
            ...
            <input type="number"
                ...
                max={lastPage}
                value={currentPage}
                onChange={ (e) => dispatch({type: 'set', value: {...state, currentPage: validateSelectedPage(e.target.value, lastPage)}})} />            
